# nvim-treesitter-queries-typespec

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-typespec/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-typespec/actions/workflows/validate.yml)

Neovim tree-sitter queries for **typespec**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-typespec",
...
- [ ] Changes are scoped to `typespec` — do not include files for other languages
